...
## Spec File
[spec-dashboard-sidebar-alignment.md](file:///c:/Users/mathe/Desktop/vortex/_bmad-output/implementation-artifacts/spec-dashboard-sidebar-alignment.md)
...
2. **Visual Integrity:** Pay close attention to CSS classes (Tailwind/Ebony tokens) like `items-center`, `justify-center`, and `w-20`. Ensure symmetry is achieved as per the Ebony design language.
